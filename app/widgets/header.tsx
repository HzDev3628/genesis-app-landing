...
export function Header() {
  ...
  return (
    <header className="w-full flex items-center justify-center px-3 mx-auto mt-6 max-w-[736px] h-[72px] rounded-20 border border-white bg-opacity-50 relative overflow-hidden">
