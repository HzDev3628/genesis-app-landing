...
export default function HeroSection1() {
  return (
    <section className="flex flex-col items-center justify-center w-full relative overflow-x-hidden h-[900px] laptop:h-[1000px] mb-40">
      <div className="w-full container flex items-center justify-center small-laptop:justify-between">
        <div className="flex flex-col small-laptop:items-start text-center small-laptop:text-start font-bold gap-8">
          ...
          <div className="flex max-small-laptop:mx-auto items-center w-max mt-2 gap-8">
            <AppDownloadLinks platform="ios" />
            <AppDownloadLinks platform="android" />
          </div>
        </div>

        <div className="max-small-laptop:hidden w-max h-max p-2 rounded-20 bg-gradient-to-br from-100 to-50 bg-opacity-50 border-50 border mt-2.5">
