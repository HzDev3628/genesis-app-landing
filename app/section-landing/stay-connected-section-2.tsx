...
const ITEMS: {
  ...
  {
    title: 'Announcements',
    description: 'Let others know what is going on at your church',
    icon: '/2-section-stay-connected/announcements.svg',
  },
  {
    title: 'Broadcasts',
    description: 'Invite nearby churches to attend and support programs',
    icon: '/2-section-stay-connected/broadcasts.svg',
  },
  {
    title: 'Calendar',
    description:
      'Add events to the calendar and notify all church members instantly',
    icon: '/2-section-stay-connected/calendar.svg',
  },
  {
    title: 'Community Services',
    description:
      'Let your community know how church can be a blessing to them.',
    icon: '/2-section-stay-connected/community-services.svg',
  },
  {
    title: 'Members Directory',
    description:
      'Get the list of members, birthdays, anniversaries and roles within the church.',
    icon: '/2-section-stay-connected/members.svg',
  },
  {
    title: 'Messages',
    description: 'Send and manage your church messages from all over the world',
    icon: '/2-section-stay-connected/messages.svg',
  },
  {
    title: 'Outreach',
    description:
      'Keep track of leads within community and assign members to follow-up with them.',
    icon: '/2-section-stay-connected/outreach.svg',
  },
  {
    title: 'Permissions',
    description:
      'Build church community by delegating roles and permissions to members',
    icon: '/2-section-stay-connected/permissions.svg',
  },
  {
    title: 'Potluck',
    description:
      'Turn pot-luck into pot-managed by letting members collaborate on dishes.',
